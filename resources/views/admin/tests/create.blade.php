...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.tests.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="sku">{{ trans('cruds.test.fields.sku') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.test.fields.sku_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="price">{{ trans('cruds.test.fields.price') }}</label>
